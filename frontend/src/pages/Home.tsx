            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-12 pb-6 border-b border-white/5">
                    <div className="flex flex-wrap items-center gap-8 text-sm font-medium text-gray-400">
                            ...
                            <div className="absolute top-full left-0 mt-2 w-48 bg-[#1a1d26] border border-white/10 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50 p-2">
                                {genres.map(genre => (
                                    <button
                                        ...
                                        className={`block w-full text-left px-3 py-2 text-sm rounded ${selectedGenre === genre ? 'bg-red-600 text-white' : 'text-gray-400 hover:bg-white/5 hover:text-white'
                                            }`}
                                    >
                                        {genre}
                                    </button>
                        ...
                        <button className="hover:text-white transition-colors">Coming soon</button>
                    </div>
                ...
                <div className="space-y-16">
                    ...
                    {trendingMovies.length > 0 && (
                        <div className="space-y-6">
                            <h2 className="text-xl font-bold text-white uppercase tracking-widest border-l-4 border-red-600 pl-4">Trending Now</h2>
                ...
                <div className="mt-32 border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center text-gray-500 text-xs">
                    <div className="flex items-center gap-2 mb-4 md:mb-0">
                        <div className="w-8 h-8 bg-red-600/20 rounded flex items-center justify-center text-red-600 font-bold">B</div>
                    ...
                    <div className="flex gap-4 mt-4 md:mt-0">
                        ...
                        {[1, 2, 3].map(i => (
                            <div key={i} className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center hover:bg-white hover:text-black transition-colors cursor-pointer">
